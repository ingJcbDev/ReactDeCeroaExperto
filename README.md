...
�Qu� veremos en esta secci�n?

* Nuestra primera aplicaci�n - Hola Mundo

* Exposiciones sobre los componentes

* Creaci�n de componentes (Functional Components)
...
* Introducci�n general a los Hooks

* useState

Es una secci�n importante, especialmente para todos los que est�n empezando de cero en React, ya que dar� las bases de c�mo segmentar la l�gica de nuestra aplicaci�n en peque�as piezas m�s f�ciles de mantener.


31. Primera aplicaci�n de React
...
## Secci�n 5: Pruebas uniarias y de integracion - probando las secciones anteriores
